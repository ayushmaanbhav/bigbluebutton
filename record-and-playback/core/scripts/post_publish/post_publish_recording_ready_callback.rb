...
#    mutex       = Mutex.new
    ...
    until files.empty?
      ...
      path = "presentation/#{recordingId}/#{file.sub(/^#{folder_path}\//, '')}"
...
begin
  ...
  uploader = S3FolderUpload.new(meeting_metadata["recordingid"], published_files, 'enlite-recordings', ENV['AWS_KEY_ID'], ENV['AWS_SECRET'], BigBlueButton.logger)
  uploader.upload!
